...
def runner(model, phases, criterion, optimizer, scheduler, dataloaders, dataset_sizes, num_epochs=1):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in phases:
            ...
            epoch_recall, epoch_precision = macro_evaluation(preds_list, labels_list)
            
            # evaluation print
            print(f'{phase} Loss: {epoch_loss:.4f} Acc: {epoch_acc:.4f} recall: {epoch_recall:.4f} Precision: {epoch_precision:.4f}')
